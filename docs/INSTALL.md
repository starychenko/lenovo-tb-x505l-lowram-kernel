...
Choose one image and download it together with `SHA256SUMS.txt` from the same
GitHub Release:
...
model and any kernel without a qualified r6/r7/r8 identity. Removal does not
